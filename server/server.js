...
app.get('/api/feed', function(req, res){
	...
	request.get({
		url: feedUrl, qs: params, json: true
...
app.post('/api/like', isAuthenticated, function(req, res){
	...
	var access_token = {access_token: req.user.accessToken};
	var likeUrl = 'https://api.instagram.com/v1/media/' + mediaId + '/likes';

	req.post({url: likeUrl, form: accessToken, json: true}, function(error, response, body){
